...
\filltitle{ru}{
  ...
  group              = {Группа 24.M71-MM},
  %
  %% Макрос filltitle ненавидит пустые строки, поэтому обязателен хотя бы символ комментария на строке
  %% Актуально всем.
  title              = {Разработка образовательного комплекса виртуального устройства и минимальной ОС на архитектуре RISC-V},
  %
  ...
  reviewerPosition   = {Ведущий инженер-программист, ООО «Специальный Технологический Центр», },
  reviewer           = {Жиданов~К.~А.}
}

% Английский титульник нужен только для ВКР, остальные виды работ могут его смело игнорировать.
\filltitle{en}{
  chair              = {System Programming’s chair},
  group              = {Group 24.M71-MM},
  title              = {Development of an educational complex of a virtual device and a minimal OS on the RISC-V architecture},
  type               = {master},
  author             = {Denis Kiselkov},
  %
  %% Possible choices:
  ...
  %% Те, что с 03 в середине --- бакалавриат, с 04 --- магистратура.
  specialty          = {09.04.04 \foreignquote{english}{Software Engineering}},
  %
  %% Possible choices:
  ...
  programme          = {ВМ.5666.2022 \foreignquote{english}{Software Engineering}},
  %
  ...
  %%   профессор --- prof.
  supervisorPosition = {Associate Professor of the Department of Systems Programming, Candidate of Physical and Mathematical Sciences,},
  supervisor         = {D.V. Lutsiv},
  %
  %consultantPosition = {position at \foreignquote{english}{Company}, degree if present},
  %consultant         = {C.C. Consultant},
  %
  reviewerPosition = {Leading Software Engineer, Special Technology Center LLC, },
  reviewer         = {Zhidanov~K.~A.}
}

...
\filltitle{ru}{
  ...
  %% Актуально всем.
  title              = {Разработка минимальных операционных систем для виртуальных устройств с различным функционалом},
  %
...
\filltitle{en}{
  ...
  title              = {Development of minimal operating systems for virtual devices with various functionality},
  type               = {master},
